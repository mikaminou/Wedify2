...
const App = () => {
  return (
    <div className="min-h-screen bg-[var(--color-background)] text-[var(--color-text)]">
      ...
      <section className="bg-gradient-to-r from-purple-50 via-pink-50 to-green-50 py-20 flex flex-col items-center">
        ...
        <div className="grid gap-12 md:grid-cols-3 container mx-auto mt-20 px-6">
          {steps.map((step, idx) => (
            <div
              key={idx}
              className="bg-white rounded-2xl shadow-lg p-8 text-center hover:scale-105 transition-transform duration-300 relative"
            >
      ...
      {/* Call to Action */}
      <section className="py-20 text-center bg-black py-20 flex flex-col items-center">
